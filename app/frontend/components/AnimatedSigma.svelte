...
<div class="animated-sigma" style="width:{size}px; height:{size}px; transform: rotate({tilt}deg);">
  <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" role="img" aria-label={title} class={className}>
    <defs>
    ...
    <g transform="translate(20,20)">
      <path d="M10 10 H140 L30 90 H140" fill="none" stroke="url(#asg1)" stroke-width="10" stroke-linecap="round" stroke-linejoin="round" class="sigma-path" />
...
<style>
  ...
  .animated-sigma:hover { transform: scale(1.02) rotate(var(--tilt, 45deg)); }
  ...
  @media (prefers-reduced-motion: reduce) {
    .sigma-path { animation: none; }
    .animated-sigma { transition: none; }
  }
</style>
